...
With that being said, this Flask App is deployed (somewhere) just for me to have a working HTTPS callback URL, and this is the only deployed part of the project. All other modules are built to be hosted and run locally!

Previously, this app was implemented as a POC for me to validate whether using Enable Banking was the right approach for this project: https://github.com/triluu03/pennysheet-poc.
